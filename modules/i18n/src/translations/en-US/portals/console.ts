...
export const console: ConsoleNS = {
    common: {
        ...
        cookieConsent: {
            ...
            content:
                "We use cookies to ensure that you get the best overall experience. These cookies are used to " +
        ...
        header: {
            ...
            featureAnnouncements: {
                organizations: {
                    message:
                        "Introducing B2B organizations. Start building your B2B platform by onboarding your " +
        ...
        modals: {
                    ...
                    hostedAvatar: {
                        ...
                        input: {
                            errors: {
                                http: {
                                    content:
                                        "The selected URL points to an insecure image served over HTTP. " +
                            ...
                            warnings: {
                                dataURL: {
                                    content:
                                        "Using Data URLs with large character count might result in database " +
            ...
            sessionTimeoutModal: {
                description:
                    "When you click on <1>Go back</1>, we will try to recover the session if " +
        ...
        quickStart: {
            ...
            sections: {
                ...
                adminNotice: {
                    ...
                    description:
                        "Effective <1>{{date}}</1>, organizations will inherit settings across multiple key areas from their parent organizations. During this window, updates to configurations made by admins may not be reflected immediately.",
                ...
                customizeFlows: {
                    ...
                    description: "Visually design and customize user flows with our no-code flow composer",
                ...
                forms: {
                    ...
                    authenticatorSettings: {
                        ...
                        emailOTP: {
                            ...
                            resendBlockDuration: {
                                hint:
                                    "The duration for which the user will be blocked from requesting a new OTP " +
                    ...
                    certificateSection: {
                        ...
                        description:
                            "The certificate information provided here is used to verify signed responses from the external Identity Provider (IdP).",
                        info:
                            "This validation is applicable only to federated IdP-initiated logout, and federated authentication flows " +
                ...
                templates: {
                    ...
                    iproov: {
                        wizardHelp: {
                            ...
                            oauthUsername: {
                                description:
                                    "Provide the <1>OAuth Username</1> of the application registered in the iProov control center.",
                                heading: "OAUTH Username",
                            },
                            oauthPassword: {
                                description:
                                    "Provide the <1>OAuth Password</1> of the application registered in the iProov control center.",
                                heading: "OAUTH Password",
                            },
                            apiKey: {
                                description:
                                    "Provide the <1>API Key</1> of the application registered in the iProov control center.",
                                heading: "API Key",
                            },
                            apiSecret: {
                                description:
                                    "Provide the <1>API Secret</1> of the application registered in the iProov control center.",
                                heading: "API Secret",
                            },
                            enableProgressiveEnrollment: {
                            ...
                            preRequisites: {
                                appDescription:
                                    "Before you begin, create an identity provider in the <1>iPortal</1>, and obtain the API key, API Secret, OAuth username and OAuth password.",
                                heading: "Prerequisite",
                            },
                        },
                    },
                ...
                quickLinks: {
                    cards: {
                        ...
                        idps: {
                            heading: "Connections",
                            subHeading:
                                "Create and manage connections based on templates and configure authentication.",
                        },
                        remoteFetch: {
        ...
        features: {
            ...
            claims: {
                attributeMappings: {
                    axschema: {
                        description:
                            "The Attribute Exchange Schema (axschema) representation " + "for user attributes.",
                        heading: "Attribute Exchange Schema",
                    },
                    custom: {
                        description: "The custom protocol representation for user " + "attributes.",
                    ...
                    oidc: {
                        description: "The OpenID Connect (OIDC) protocol representation for user " + "attributes.",
                        heading: "OpenID Connect",
                    },
                    scim: {
                        description:
                            "The SCIM2 protocol representation for " + "attributes that will be used in the SCIM2 API.",
                        heading: "SCIM 2.0",
                    },
                },
                dialects: {
                    ...
                    confirmations: {
                        action: "Confirm",
                        content:
                            "If you delete this attribute mapping, all the associated {{type}} attributes will " +
                            "also be deleted. Please proceed with caution.",
                        header: "Are you sure?",
                        hint: "Please type <1>{{confirm}}</1> to confirm.",
                        message:
                            "This action is irreversible and will permanently delete the selected attribute " +
                            "mapping.",
                    },
                    dangerZone: {
                        ...
                        subheader:
                            "Once you delete this {{type}} attribute mapping, there is no going back. " +
                            "Please be certain.",
                    },
                    forms: {
                        dialectURI: {
                        ...
                        fields: {
                            attributeName: {
                                validation: {
                                    ...
                                    invalid:
                                        "Attribute name can only contain alphanumeric characters " +
                    ...
                    notifications: {
                        addDialect: {
                            ...
                            genericError: {
                                description:
                                    "The attribute mapping has been added but not all {{type}} " +
                    ...
                    pageLayout: {
                        ...
                        list: {
                            description:
                                "View and manage how user attributes are mapped and " +
                    ...
                    sections: {
                        manageAttributeMappings: {
                            ...
                            description:
                                "View and manage how attributes are mapped and transformed " +
                            ...
                            scim: {
                                description:
                                    "Communicate information about the user via the API " +
                ...
                external: {
                    ...
                    forms: {
                        attributeURI: {
                            ...
                            validationErrorMessages: {
                                ...
                                scimInvalidName:
                                    "The starting character of the name should be a letter. " +
                        ...
                        warningMessage:
                            "There are no local attributes available for mapping. " + "Add new local attributes from",
                    },
                    notifications: {
                        addExternalAttribute: {
                            ...
                            success: {
                                description:
                                    "The {{type}} attribute has been added to the attribute mapping" + " successfully!",
                    ...
                    placeholders: {
                        empty: {
                            subtitle:
                                "Currently, there are no {{type}} attributes available for " +
                ...
                list: {
                    ...
                    confirmation: {
                        ...
                        dialect: {
                            message:
                                "If you delete this attribute mapping, all the" +
                        ...
                        local: {
                            message:
                                "If you delete this attribute, the user data belonging " +
                    ...
                    warning: "This attribute has not been mapped to an attribute" + " in the following user stores:",
                },
                local: {
                    ...
                    confirmation: {
                        content:
                            "If you delete this attribute, the user data belonging to this attribute " +
                    ...
                    dangerZone: {
                        ...
                        subheader: "Once you delete an attribute, there is no going back. " + "Please be certain.",
                    },
                    forms: {
                        attribute: {
                        ...
                        displayOrderHint:
                            "This determines the position at which this attribute is " +
                            "displayed in the user profile and the user registration page",
                        infoMessages: {
                            configApplicabilityInfo:
                                "Please note that the following attribute configurations will " +
                                "only affect the customer users' profiles.",
                            disabledConfigInfo:
                                "Please note that below section is disabled as there is no " +
                        ...
                        name: {
                            ...
                            validationErrorMessages: {
                                invalidName:
                                    "The name you entered contains disallowed characters. It can only" +
                        ...
                        readOnlyHint:
                            "If this is selected, the value of this attribute is read-only in a user" +
                        ...
                        requiredHint:
                            "If selected, the user is required to specify a value for this " +
                            "attribute on the profile.",
                        requiredWarning:
                            "To make the email attribute not display and not required on the user's profile, " +
                    ...
                    notifications: {
                        ...
                        updateClaim: {
                            ...
                            success: {
                                description: "This attribute has been " + "updated successfully!",
                ...
                scopeMappings: {
                    deletionConfirmationModal: {
                        assertionHint: "Please confirm your action.",
                        content:
                            "If you delete this claim, it will not be available in the token." +
                            " Please proceed with caution.",
                        header: "Are you sure?",
            ...
            emailTemplateTypes: {
                ...
                confirmations: {
                    deleteTemplateType: {
                        ...
                        header: "Are you sure?",
                        message:
                            "This action is irreversible and will permanently delete the selected email " +
                            "template type.",
                    },
                },
                forms: {
                        ...
                        connectors: {
                            ...
                            analyticsEngine: {
                                ...
                                messages: {
                                    deprecation: {
                                        description:
                                            "WSO2 Identity Server Analytics is now deprecated. Use <1>ELK Analytics</1> instead.",
                                        heading: "Deprecated",
                                    },
                                },
                                properties: {
            ...
            invite: {
                ...
                confirmationModal: {
                    deleteInvite: {
                        assertionHint: "Please confirm your action.",
                        content:
                            "If you revoke this invite, the user will not be able to onboard your organization. " +
                            "Please proceed with caution.",
                        header: "Are you sure?",
                    ...
                    resendInvite: {
                        assertionHint: "Please confirm your action.",
                        content:
                            "If you resend the invitation, the previous invitation link will be revoked. " +
                            "Please proceed with caution.",
                        header: "Are you sure?",
            ...
            oidcScopes: {
                ...
                confirmationModals: {
                    deleteClaim: {
                        assertionHint: "Please type <1>{{ name }}</1> to confirm.",
                        content:
                            "If you delete this claim, you will not be able to get it back." +
                            "Please proceed with caution.",
                        header: "Are you sure?",
                    ...
                    deleteScope: {
                        assertionHint: "Please confirm your action.",
                        content:
                            "If you delete this scope, you will not be able to get it back. " +
                            "Please proceed with caution.",
                        header: "Are you sure?",
                        ...
                        inputs: {
                            ...
                            scopeName: {
                                ...
                                validations: {
                                    ...
                                    empty: "This field cannot be empty.",
                                    invalid:
                                        "Scope can only contain alphanumeric characters and _. " +
                ...
                notifications: {
                    ...
                    claimsMandatory: {
                        error: {
                            description:
                                "To add a scope, you need to make sure that the scope " + "has at least one attribute.",
            ...
            onboarded: {
                confirmationModal: {
                    removeUser: {
                        assertionHint: "Please confirm your action.",
                        content:
                            "If you remove this user, the user will not be able to access the console " +
            ...
            organizationDiscovery: {
                ...
                message:
                    "Email domain discovery feature can only be used when email address is configured as the username.",
                notifications: {
                    addEmailDomains: {
                        error: {
                    ...
                    getOrganizationListWithDiscovery: {
                        error: {
                            description:
                                "An error occurred while getting the organization list with discovery attributes.",
                            message: "Retrieval unsuccessful",
                        },
                    },
            ...
            organizations: {
                ...
                confirmations: {
                    deleteOrganization: {
                        assertionHint: "Please confirm your action.",
                        content:
                            "If you remove this organization, all the data associated with this" +
                ...
                edit: {
                    ...
                    dangerZone: {
                        disableOrganization: {
                            ...
                            subheader:
                                "Disabling an organization will make it unavailable for all users. " +
                                "Proceed with caution.",
                        },
                ...
                notifications: {
                    ...
                    deleteOrganizationWithSubOrganizationError:
                        "Organization {{ organizationName }} cannot be " +
                ...
                shareApplicationInfo:
                    "Select this to share the application with all the existing organizations " +
                ...
                unshareApplicationInfo:
                    "This will allow you to prevent sharing this application with any of the " +
            ...
            serverConfigs: {
                adminAdvisory: {
                    configurationEditSection: {
                        ...
                        pageSubheading:
                            "Configure and customize the admin advisory banner to be displayed on the login page.",
                        form: {
                            bannerContent: {
                ...
                remoteLogPublishing: {
                    ...
                    descriptionWithLogType:
                        "Configure remote logging settings for " + "{{logType}} logs in the organization.",
                    ...
                    fields: {
                        ...
                        advanced: {
                            ...
                            basicAuthConfig: {
                                ...
                                info: {
                                    message:
                                        "If you are changing the authentication, be aware that the authentication" +
                                        " secrets of the remote server need to be updated.",
                                    title: {
                                        noneAuthType: "No authentication is configured.",
                                        otherAuthType:
                                            "<strong>{{ authType }}</strong> authentication scheme is configured.",
                                    },
                                },
                                types: {
                                    none: {
                            ...
                            sslConfig: {
                                ...
                                info: {
                                    ...
                                    notConfigured: {
                                        message:
                                            "SSL is not currently configured. Please set it up to secure your connections.",
                    ...
                    dangerZone: {
                        ...
                        subheader:
                            "This action will delete the existing configuration for {{logType}} logs. Please be certain before you proceed.",
                        confirmation: {
                            hint: "Please confirm your action.",
                            header: "Are you sure?",
                            message:
                                "If you restore the default configuration, remote log publishing for {{logType}} logs may not work properly. " +
                                "Please proceed with caution.",
                            content:
                                "This action will restore the default log publishing configuration for {{logType}} logs.",
                        },
                    },
                    notification: {
                        success: {
            ...
            user: {
                deleteJITUser: {
                    confirmationModal: {
                        content:
                            "If you delete this user, the user will not be able to log in to My Account or any " +
                ...
                deleteUser: {
                    confirmationModal: {
                        assertionHint: "Please confirm your action.",
                        content:
                            "If you delete this user, the user will not be able to log in to My Account or " +
                ...
                disableUser: {
                    confirmationModal: {
                        assertionHint: "Please confirm your action.",
                        content:
                            "If you disable this user, the user will not be able to log in to My Account or " +
                        ...
                        inputs: {
                            ...
                            email: {
                                ...
                                validations: {
                                    ...
                                    invalid:
                                        "Please enter a valid email address. You can use alphanumeric " +
                ...
                lockUser: {
                    confirmationModal: {
                        assertionHint: "Please confirm your action.",
                        content:
                            "If you lock this account, the user will not be able to sign in to " +
                ...
                modals: {
                    addUserWarnModal: {
                        heading: "Warning",
                        message:
                            "Please note that this created user will not be assigned with a role. If you " +
                            "wish to assign roles to this user please click on the button below.",
                    },
                    addUserWizard: {
                        askPassword: {
                            alphanumericUsernameEnabled:
                                "To invite users to set the password, disable " + "alphanumeric username feature.",
                            emailInvalid: "To invite users to set the password, please enter a valid email address.",
                            emailVerificationDisabled:
                                "To invite users to set the password, enable email invitations for user password setup from <1>Login & Registration settings</1>.",
                            mobileNumberAlreadyExists:
                                "Mobile number is required for SMS OTP, please enable mobile number attribute from <1>Attributes</1>.",
                    ...
                    bulkImportUserWizard: {
                        ...
                        wizardSummary: {
                            ...
                            tableMessages: {
                                ...
                                userAssignmentInternalErrorMessage:
                                    "An error occurred while assigning users to " + "{{resource}}",
                            },
                            tableStatus: {
                                success: "Success",
                                warning: "Warning",
                            ...
                            alerts: {
                                ...
                                importFailed: {
                                    userCreation:
                                        "Issues encountered in <1>{{failedUserCreationCount}} user " +
                                        "creation operations(s)</1>",
                                    groupAssignment:
                                        "Issues encountered in <1>{{failedUserAssignmentCount}} group " +
                            ...
                            manualCreation: {
                                ...
                                disabledHint:
                                    "The manual option is disabled due to the usage of alphanumeric usernames in your organization.",
                                upload: {
                                ...
                                warningMessage:
                                    "This option can only be used when email address is configured " +
                                    "as the username.",
                            },
                            fileBased: {
                            ...
                            userstoreMessage:
                                "The created users will be added to the <1>{{ userstore }}</1> user store.",
                        },
                        buttons: {
                            import: "Import",
                        },
                        sidePanel: {
                            ...
                            fileFormatContent:
                                "Headers of the CSV file should be user attributes that are " +
                    ...
                    changePasswordModal: {
                        ...
                        hint: {
                            forceReset:
                                "WARNING: Please note that after inviting the user to change the password " +
                            ...
                            setPassword:
                                "WARNING: Please note that after changing the password the user will " +
                                "no longer be able to log into any application using the current password.",
                        },
                        message:
                            "WARNING: Please note that after changing the password the user will no longer be " +
                ...
                revokeAdmin: {
                    confirmationModal: {
                        assertionHint: "Please confirm your action.",
                        content:
                            "If you revoke the admin privileges of this user, the user will not be able " +
                ...
                updateUser: {
                    groups: {
                        ...
                        editGroups: {
                            ...
                            subHeading:
                                "Add or remove the groups user is assigned with and note that this will " +
                    ...
                    roles: {
                        ...
                        editRoles: {
                            confirmationModal: {
                                assertionHint: "Please confirm your action.",
                                content:
                                    "Modifying the role will result in the user either losing " +
            ...
            userstores: {
                ...
                confirmation: {
                    confirm: "Confirm",
                    content:
                        "If you delete this user store, the user data in this user store will also be deleted. " +
                        "Please proceed with caution.",
                    header: "Are you sure?",
                    hint: "Please confirm your action.",
                    message:
                ...
                dangerZone: {
                    delete: {
                        ...
                        subheader: "Once you delete a user store, there is no going back. " + "Please be certain.",
                    },
                    disable: {
                        actionTitle: "Enable User Store",
                        header: "Enable User Store",
                        subheader:
                            "Disabling a user store can make you lose access to the users in the user store. " +
                            "Proceed with caution.",
                    },
                },
                forms: {
                    connection: {
                        ...
                        connectionErrorMessage:
                            "Please ensure the provided connection " +
                        ...
                        name: {
                            ...
                            validationErrorMessages: {
                                ...
                                invalidInputErrorMessage:
                                    "User store name cannot contain the pattern {{invalidString}}.",
                            },
                        },
                        type: {
                            label: "Type",
                ...
                notifications: {
                    ...
                    delay: {
                        description:
                            "It may take a while for the user store list to be updated. " +
                ...
                placeholders: {
                    emptyList: {
                        ...
                        subtitles:
                            "There are currently no user stores available. " +
            ...
            validation: {
                ...
                validationError: {
                    ...
                    uniqueChrMismatch:
                        "Number of unique characters should be less than tha minimum length of " + "the password.",
                    consecutiveChrMismatch:
                        "Number of consecutive characters should be less than tha minimum " + "length of the password.",
            ...
            insights: {
                ...
                graphs: {
                    activeUsers: {
                        title: "Active Users",
                        titleHint:
                            "Number of unique users that signed in to your organization within the selected period",
                    },
                    successLogins: {
                        title: "Total Logins",
            ...
            smsProviders: {
                ...
                confirmationModal: {
                    assertionHint: "Please confirm your action.",
                    content:
                        "Deleting this SMS provider configuration may disrupt SMS OTP authentication for " +
                ...
                dangerZoneGroup: {
                    ...
                    revertConfig: {
                        ...
                        subHeading:
                            "This action will delete sms provider configurations. " +
            ...
            approvalWorkflows: {
                ...
                confirmation: {
                    confirm: "Confirm",
                    content:
                        "If you delete this approval workflow, the data in this approval workflow will also be deleted. " +
                        "Please proceed with caution.",
                    header: "Are you sure?",
                    hint: "Please confirm your action.",
                    message:
                ...
                dangerZone: {
                    delete: {
                        ...
                        subheader:
                            "Once you delete an approval workflow, there is no going back. " + "Please be certain.",
                    },
                },
                forms: {
                    general: {
                        ...
                        name: {
                            ...
                            validationErrorMessages: {
                                ...
                                maxCharLimitErrorMessage:
                                    "Approval Workflow name cannot exceed {{maxLength}} characters.",
                                invalidInputErrorMessage:
                                    "Approval Workflow name cannot contain the pattern {{invalidString}}.",
                            },
                        },
                    },
                },
